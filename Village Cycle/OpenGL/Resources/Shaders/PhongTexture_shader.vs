//
// This performs lighting in world coordinate space and uses a texture to provide basic diffuse surface properties.
//
...
void main(void) {
	...
	posWorldCoord = modelMatrix * (vertexPos + vec4(vertexOffset, 1.0f));
	...
	//Sending in the texture coodinates to the fragment shader
